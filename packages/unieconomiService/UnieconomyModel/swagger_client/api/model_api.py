...
class ModelApi(object):
    ...
    def models_id_put(self, body, id, **kwargs):  # noqa: E501
        """models_id_put  # noqa: E501

        Update Model  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.models_id_put(body, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.models_id_put_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.models_id_put_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def models_id_put_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """models_id_put  # noqa: E501

        Update Model  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.models_id_put_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
