...
class AmeldingSumUpApi(object):
    ...
    def ameldingsums_idactionget_sumup_get_with_http_info(self, id, id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method ameldingsums_idactionget_sumup_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `ameldingsums_idactionget_sumup_get`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `ameldingsums_idactionget_sumup_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ameldingsums/{id}?action=get-sumup', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='AmeldingSumUp',  # noqa: E501
