...
class RoleApi(object):
    ...
    def roles_id_put(self, body, id, **kwargs):  # noqa: E501
        """roles_id_put  # noqa: E501

        Update Role  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.roles_id_put(body, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.roles_id_put_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.roles_id_put_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def roles_id_put_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """roles_id_put  # noqa: E501

        Update Role  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.roles_id_put_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `roles_id_put`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `roles_id_put`")  # noqa: E501
